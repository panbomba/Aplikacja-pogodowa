...
public class MainWindowController extends BaseController implements Initializable {
    ...
    public static final String WEATHER_API_URL = "http://openweathermap.org/img/wn/";
    ...
    public void setSceneDataCity1(String city1) throws IOException {
        ...
        Map<String,String> weatherNow = weatherDataManager.getWeatherToday(city1NoSpaces);
        Map<String,String> forecast = weatherDataManager.getForecastMap(city1NoSpaces);
        actualizationCity1.setText("aktualizacja: " + weatherDataManager.getTimeStamp());
        tempTodayCity1.setText(weatherNow.get("temperature") + degrees + " C");
        feelslikeTodayCity1.setText("odczuwalna: " + weatherNow.get("feelslike") + degrees + " C");
        minToday1.setText("minimalna: " + weatherNow.get("min") + degrees + " C");
        maxToday1.setText("maksymalna: " + weatherNow.get("max") + degrees + " C");
        humidityToday1.setText("wilgotność: " + weatherNow.get("humidity") +
                " %");
        pressureToday1.setText("ciśnienie: " + weatherNow.get("pressure") +
                " hPa");
        descriptionTodayCity1.setText(weatherNow.get("description"));

        String icon = weatherNow.get("icon");
        String iconLink = (WEATHER_API_URL + icon + "@2x.png");
        ...
        String iconDay1 = forecast.get("day1icon");
        String iconLinkDay1 = (WEATHER_API_URL + iconDay1 + "@2x.png");
        ...
        descriptionDay1City1.setText(forecast.get("day1desc"));

        String iconDay2 = forecast.get("day2icon");
        String iconLinkDay2 = (WEATHER_API_URL + iconDay2 + "@2x.png");
        ...
        descriptionDay2City1.setText(forecast.get("day2desc"));

        String iconDay3 = forecast.get("day3icon");
        String iconLinkDay3 = (WEATHER_API_URL + iconDay3 + "@2x.png");
        ...
        descriptionDay3City1.setText(forecast.get("day3desc"));

        String iconDay4 = forecast.get("day4icon");
        String iconLinkDay4 = (WEATHER_API_URL + iconDay4 + "@2x.png");
        ...
        descriptionDay4City1.setText(forecast.get("day4desc"));

        String iconDay5 = forecast.get("day5icon");
        String iconLinkDay5 = (WEATHER_API_URL + iconDay5 + "@2x.png");
        ...
        descriptionDay5City1.setText(forecast.get("day5desc"));

    }

    public void setSceneDataCity2(String city2) throws IOException {
        String city2NoSpaces = city2.replace(" " , "+");
        Map<String,String> weatherNow = weatherDataManager.getWeatherToday(city2NoSpaces);
        actualizationCity2.setText("aktualizacja: " + weatherDataManager.getTimeStamp());
        tempTodayCity2.setText(weatherNow.get("temperature") + degrees + " C");
        feelslikeTodayCity2.setText("odczuwalna: " + weatherNow.get("feelslike") + degrees + " C");
        minToday2.setText("minimalna: " + weatherNow.get("min") + degrees + " C");
        maxToday2.setText("maksymalna: " + weatherNow.get("max") + degrees + " C");
        humidityToday2.setText("wilgotność: " + weatherNow.get("humidity") +
                " %");
        pressureToday2.setText("ciśnienie: " + weatherNow.get("pressure") +
                " hPa");
        descriptionTodayCity2.setText(weatherNow.get("description"));
        ...
        Map<String, String> forecast = weatherDataManager.getForecastMap(city2NoSpaces);
        ...
        descriptionDay1City2.setText(forecast.get("day1desc"));
        ...
        descriptionDay2City2.setText(forecast.get("day2desc"));
        ...
        descriptionDay3City2.setText(forecast.get("day3desc"));
        ...
        descriptionDay4City2.setText(forecast.get("day4desc"));
        ...
        descriptionDay5City2.setText(forecast.get("day5desc"));
